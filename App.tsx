...
import { TOPICS, TIER_2_TOPICS } from './data';
...
const App: React.FC = () => {
  ...
  // Separate Main Table vs Bulletin Board (Command)
  ...
  const handleDrop = (e: React.DragEvent) => {
    ...
    const topic = TOPICS.find(t => t.symbol === symbol);
  ...
  return (
    <div 
        className="min-h-screen text-white pb-40 relative flex flex-col"
        onDrop={handleDrop} 
    ...
    >
      ...
      <header className="pt-8 pb-4 text-center px-4 relative z-10">
        ...
        <p className="text-gray-500 font-mono text-xs max-w-lg mx-auto mb-6">
          MARKET DATA // VERSION 3.1 // BUILDER ACTIVE
        </p>
      ...
      {/* --- MAIN GRID --- */}
      <main className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10 mb-12 flex-grow">
